...
publication_date:[2001-01-01T00:00:00Z TO 2013-12-31T23:59:59Z]<br />
[/code]</p>
...
searchplos(<br />
  # Query: publication date in 2012<br />
  q  = 'publication_date:[2012-01-01T00:00:00Z TO 2012-12-31T23:59:59Z]', </p>
<p>  # Fields to return: id (doi) and author list<br />
  fl = &quot;id,author&quot;, </p>
<p>  # Filter: only actual articles in journal PLOS ONE<br />
  fq = list(&quot;doc_type:full&quot;,<br />
            &quot;cross_published_journal_key:PLoSONE&quot;), </p>
<p>  # 500 results (max 1000 per query)<br />
  start=0, limit=500, sleep=6)<br />
[/code]</p>
...
<p><a href="http://benjaminlmoore.files.wordpress.com/2014/04/beans_overall.png"><img class="aligncenter size-large wp-image-605" src="img/beans_overall.png?w=500" alt="Distribution of author counts" width="500" height="500" /></a><br />
<a href="http://benjaminlmoore.files.wordpress.com/2014/04/journal_ecdf.png"><img class="alignright size-medium wp-image-608" src="img/journal_ecdf.png?w=300" alt="ECDF per journal" width="300" height="300" /></a></p>
...
<p><a href="http://benjaminlmoore.files.wordpress.com/2014/04/alltrends.png"><img class="aligncenter size-large wp-image-603" src="img/alltrends.png?w=500" alt="PLOS author inflation" width="500" height="500" /></a></p>
...
<p><a href="http://benjaminlmoore.files.wordpress.com/2014/04/plot_lm.png"><img class="aligncenter size-large wp-image-621" src="img/plot_lm.png?w=500" alt="Author inflation regression" width="500" height="352" /></a></p>
...
<p><a href="http://benjaminlmoore.files.wordpress.com/2014/04/corr_authif.png"><img class="aligncenter size-medium wp-image-665" src="img/corr_authif.png?w=300" alt="Correlation of author inflation and impact factor" width="300" height="300" /></a></p>
...
<hr />
<h4>Full code to reproduce analysis</h4>
<p>https://gist.github.com/blmoore/9998523</p>
