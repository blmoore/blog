...
<p>[caption id="attachment_472" align="aligncenter" width="500"]<a href="http://benjaminlmoore.files.wordpress.com/2014/02/screen-shot-2014-02-24-at-22-20-531.png"><img class="size-large wp-image-472" alt="The final(ish) presentation in all its glory. Link may not work for long." src="img/screen-shot-2014-02-24-at-22-20-531.png?w=500" width="500" height="318" /></a> The final(ish) presentation in all its glory. Link may not work for long.[/caption]</p>
