...
<p><a href="http://benjaminlmoore.files.wordpress.com/2014/05/rottentomatohits.png"><img class="aligncenter size-medium wp-image-689" src="img/rottentomatohits.png?w=300" alt="Films returned" width="300" height="300" /></a></p>
<h2>Results</h2>
...
<p><a href="http://benjaminlmoore.files.wordpress.com/2014/05/rt_plot.png"><img class="aligncenter size-large wp-image-697" src="img/rt_plot.png?w=500" alt="Most over- and underrated films" width="500" height="533" /></a></p>
...
<p>[caption id="attachment_712" align="alignright" width="187"]<a href="http://blm.io/movies"><img class="wp-image-712" src="img/screen-shot-2014-05-08-at-02-11-47.png?w=300" alt="" width="187" height="176" /></a> Click for interactive version.[/caption]</p>
<h3>Update:</h3>
...
<p>[caption id="attachment_691" align="aligncenter" width="500"]<a href="http://benjaminlmoore.files.wordpress.com/2014/05/under_table.png"><img class="wp-image-691 size-large" src="img/under_table.png?w=500" alt="Scores are shown out of 100 for both aggregated critics and members of Rotten Tomatoes." width="500" height="366" /></a> Scores are shown out of 100 for both aggregated critics and members of Rotten Tomatoes.[/caption]</p>
...
<p>[caption id="attachment_693" align="aligncenter" width="500"]<a href="http://benjaminlmoore.files.wordpress.com/2014/05/rt_films.png"><img class="size-large wp-image-693" src="img/rt_films.png?w=500" alt="Above shows a &quot;want to see&quot; rating, different to the &quot;liked it&quot; rating returned by the API and shown below" width="500" height="355" /></a> Above shows a "want to see" rating, different to the "liked it" rating returned by the API and shown below. Note: these screenshots from RottenTomatoes.com are not CC licensed and is shown here under a claim of Fair Use, reproduced for comment/criticism.[/caption]</p>
...
<p>[caption id="attachment_696" align="aligncenter" width="500"]<a href="http://benjaminlmoore.files.wordpress.com/2014/05/over_table.png"><img class="size-large wp-image-696" src="img/over_table.png?w=500" alt="As before, scores are out of 100 and they're ranked by difference between audience and critic scores." width="500" height="400" /></a> As before, scores are out of 100 and they're ranked by difference between audience and critic scores.[/caption]</p>
...
<h5>Full code to reproduce analysis</h5>
<p>Note: If you're viewing this on r-bloggers, you may need to visit <a href="http://benjaminlmoore.wordpress.com/2014/05/05/what-are-the-most-overrated-films/">the Benomics version</a> to see the attached gist.</p>
<p>https://gist.github.com/blmoore/dc3bfa9a3ad0857ac796</p>
<p>&nbsp;</p>
